...
export default function CursorBubble() {
    useEffect(() => {
        ...
        const onMouseOver = (e) => {
            ...
            if (found && !isHoveringClickable) {
                ...
                if (found.matches('.logo-truus')) cursorBubble.textContent = 'início';
                else if (found.matches('.nav-work-btn')) cursorBubble.textContent = 'clique';
                else cursorBubble.textContent = 'clique';
    ...
    return <div className="cursor-bubble">clique</div>;
}
