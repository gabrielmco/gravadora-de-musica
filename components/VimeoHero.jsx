...
export default function VimeoHero() {
    ...
    return (
        <>
            ...
            >
                <img
                    src="/assets/ai-generated/hero-music-label.png"
                    alt=""
                    className="vimeo-hero__image"
                    fetchPriority="high"
                />
                ...
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* "nós" */}
                        <span className="vimeo-hero__word">nós </span>

                        {/* "fazemos" + ⑤ smiley (no animation) */}
                        ...
                        {/* "música" italic */}
                        <span className="vimeo-hero__word"><em>música </em></span>

                        {/* "para" */}
                        <span className="vimeo-hero__word">para </span>

                        <div style={{ flexBasis: '100%', height: 0 }} />

                        <span className="vimeo-hero__word">a </span>
                        <span className="vimeo-hero__word">nova </span>

                        {/* "geração" + ⑤ pink star (no spin) + oval underline */}
                        <span className="vimeo-hero__word is--relative">
