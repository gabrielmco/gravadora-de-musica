                ...
                <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-work-container">
                            ...
                            <span className="logo-work-text">trabalhos</span>
                        </div>
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/assets/ai-generated/work-douwe.png" loading="eager" alt="Feestje bouwe? App Douwe" className="nav-work-item__img" />
                                    </div>
                                ...
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/assets/ai-generated/work-school.png" loading="eager" alt="Skibidi school" sizes="100vw" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                ...
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/assets/ai-generated/work-social.png" loading="eager" alt="Hema socials" sizes="100vw" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">hema</span>
                                ...
                                <a href="#" className="nav-work-btn"><span className="nav-work-btn__text">Todos os trabalhos</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="nav-hover-trigger">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                ...
                                <h4 className="nav-wa-title">fale no whatsapp</h4>
                                <p className="nav-wa-desc">Escaneie o QR code para conversar conosco pelo seu smartphone.</p>
                                <a href="#" className="nav-wa-link">
                                    <span className="nav-wa-link-text">Conversar pelo computador</span>
