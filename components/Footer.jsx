        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    <span className="footer-badge">procurando emprego?</span>
                    <h3>não estamos contratando no momento :(</h3>
                </div>
                {/* Office */}
                <div className="footer-column">
                    <span className="footer-badge">escritório</span>
                    <address>
                        papaverhof 21<br />
                        1032 LX amsterdam
                    </address>
                ...
                {/* Contact */}
                <div className="footer-column">
                    <span className="footer-badge">contato</span>
                    <a href="mailto:hello@truus.co" className="footer-email">hello@truus.co</a>
                    <a href="#" className="footer-whatsapp">mande um whatsapp*</a>
                    <p className="footer-note">*somos millennials e gen-z: por favor, não ligue.</p>
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    <div className="overflow-wrapper"><span className="credits-label">design por</span></div>
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Jordan</a></div>
                                </div>
                                <div className="credits-item credit-wiggle">
                                    <div className="overflow-wrapper"><span className="credits-label">código por</span></div>
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Dennis</a></div>
                                </div>
                            </div>
                        </div>
                        <a href="#" className="footer-credits">créditos</a>
                    </div>
                </div>
            </div>
        </div>
